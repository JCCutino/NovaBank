  ...
  <main>
    ...
    <div class="offcanvas offcanvas-start show" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
      ...
      <div class="offcanvas-body">
        ...
        <div class="enlaces">
          <a href="pagina_principal.php" class="morado">Inicio</a>
    ...
    <div class="container-fluid ">
      ...
      <div class="col-lg-3 col-md-12  order-2 container-invisible" ></div>
        ...
        <div class="video-container">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/9sCVcWD1Svs?si=wdAm_-p09q4hscxQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        </div>
